...
## What's in this folder
    ...
    index.html            the portfolio — home page and every case study
    admin.html            the control panel
    cms.js                shared content layer
    case-data.js          shipped case-study copy (site + panel read it)
